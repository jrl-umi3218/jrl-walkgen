...
template <class T>
T VNL::Det(T const *row0, T const *row1) {
  return row0[0]*row1[1] - row0[1]*row1[0];
}

template <class T>
T VNL::Det(T const *row0, T const *row1, T const *row2) {
...
template <class T>
T VNL::Det(T const *row0, T const *row1, T const *row2, T const *row3) {
  return
...
namespace VNL { \
template T Det(T const *, T const *); \
template T Det(T const *, T const *, T const *); \
template T Det(T const *, T const *, T const *, T const *); \
};
