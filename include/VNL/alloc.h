...
#include <cstddef> // size_t lives here, not in <cstdlib>

const int VNL_ALLOC_ALIGN = 8;
const size_t VNL_ALLOC_MAX_BYTES = 256;
const size_t VNL_ALLOC_NFREELISTS = VNL_ALLOC_MAX_BYTES/VNL_ALLOC_ALIGN;
