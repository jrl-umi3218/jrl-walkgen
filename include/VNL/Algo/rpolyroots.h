// This is vxl/VNL/algo/rpoly_roots.h
...
*/
  ...
  RPolyRoots(const VNL::Vector<double>& a);

/** Calculate roots of a vnl_real_polynomial.\ Same comments apply.
*/
  RPolyRoots(const RealPolynomial& poly);
...
*/
  VNL::Vector<std::complex<double> > Roots() const;
...
*/
  VNL::Vector<double>& Real() { return r_; }

/** Vector of imaginary parts of roots.
*/
  VNL::Vector<double>& Imag() { return i_; }
...
*/
  VNL::Vector<double> RealRoots(double tol = 1e-12) const;
...
*/
  bool ComputeLaguerre();

 protected:
  // Data Members--------------------------------------------------------------
  VNL::Vector<double> coeffs_;

  VNL::Vector<double> r_;
  VNL::Vector<double> i_;
