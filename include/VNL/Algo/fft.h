...
*/
void FFTSetgpfa(float  *triggs, int size, int pqr[3], int *info);
/** use C++ overloading to find the correct FORTRAN routine from templated FFT code.
*/
void FFTSetgpfa(double *triggs, int size, int pqr[3], int *info);
...
void FFTgpfa(float  *a, float  *b, float const  *triggs,
                  int inc, int jump, int n,
                  int lot, int isign, int const pqr[3], int *info);
void FFTgpfa(double *a, double *b, double const *triggs,
                  int inc, int jump, int n,
                  int lot, int isign, int const pqr[3], int *info);
