// This is VNL/Algo/netlibsymbols.h
#ifndef vnl_netlibsymbols_h_
#define vnl_netlibsymbols_h_
/**
* \file
...
// xPOFA
#define vnl_netlib_pofa_proto(T) \
T *a, \
int* lda, \
int* n, \
int* info
#define vnl_netlib_pofa_params \
a, lda, n, info

// xPOCO
#define vnl_netlib_poco_proto(T) \
T *a, \
int *lda, \
int *n, \
T *rcond, \
T *z, \
int *info
#define vnl_netlib_poco_params \
a, lda, n, rcond, z, info

// xPODI
#define vnl_netlib_podi_proto(T) \
T *a, \
const int *lda, \
const int *n, \
T *det, \
const int *job
#define vnl_netlib_podi_params \
a, lda, n, det, job

// xPOSL
#define vnl_netlib_posl_proto(T) \
const T *a, \
const int *lda, \
const int *n, \
T *b
#define vnl_netlib_posl_params \
a, lda, n, b
...
struct vnl_netlib
{
  ...
  // when std::complex is a #define for complex.
  typedef int                 integer;
  typedef float               real;
