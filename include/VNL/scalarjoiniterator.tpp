// This is ./vxl/VNL/scalar_join_iterator.t
#ifndef vnl_scalar_join_iterator_t_
#define vnl_scalar_join_iterator_t_
...
#include "scalar_join_iterator.h"
#include <vcl_list.t>
...
{
  return s << p.original_index << " " << *(p.object) << std::endl;
}
...
#endif // vnl_scalar_join_iterator_t_
