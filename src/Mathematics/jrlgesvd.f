      SUBROUTINE JRLGESVD( JOBU, JOBVT, M, N, A, LDA, S, U, LDU, 
...
*  =======
*
*  JRLGESVD computes the singular value decomposition (SVD) of a real
...
*
            MNTHR = ILAENV( 6, 'JRLGESVD', JOBU // JOBVT, M, N, 0, 0 )
            BDSPAC = 5*N
            IF( M.GE.MNTHR ) THEN
               IF( WNTUN ) THEN
*
