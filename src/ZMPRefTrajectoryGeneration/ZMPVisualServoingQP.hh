...
#ifndef _ZMPVISUALSERVOINGQP_WITH_CONSTRAINT_H_
#define _ZMPVISUALSERVOINGQP_WITH_CONSTRAINT_H_
...
namespace PatternGeneratorJRL
{
  ...
  class  ZMPVisualServoingQP : public ZMPRefTrajectoryGeneration
  {

  public:

    /* Default constructor. */
    ZMPVisualServoingQP(SimplePluginManager *lSPM, string DataFile,
