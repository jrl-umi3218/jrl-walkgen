							    ...
							    unsigned int N)
{
  ...
  MAL_C_eq_A_by_B(lterm1,lterm1, PPu);
  MAL_C_eq_A_by_B(lterm1,beta,lterm1);

  MAL_MATRIX(lterm2,double);
  lterm2 = MAL_RET_TRANSPOSE(VPu);
  MAL_C_eq_A_by_B(lterm2,lterm2, VPu);
  MAL_C_eq_A_by_B(lterm2,alpha,lterm2);
  ...
  MAL_C_eq_A_by_B(OptB,OptB,VPx);
  MAL_C_eq_A_by_B(OptB,alpha,OptB);
  OptB += beta * lterm1;
