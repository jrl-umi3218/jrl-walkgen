...
void StraightWalkingPBW(PatternGeneratorInterface &aPGI)
{
  ...
  {
    istringstream strm2(":setpbwconstraint XY 0.0 0.0");
    aPGI.ParseCmd(strm2);
  }
...
int main(void)
{
  ...
  for(unsigned int i=0;i<MAL_MATRIX_NB_ROWS(InitialPosition);i++)
  ...
  for(unsigned int i=0;i<MAL_MATRIX_NB_ROWS(UpperBodyAngles);i++)
