...
namespace PatternGeneratorJRL
{
  ...
  private:
	...
	/*! QP formulation with stepping position reference. */
    OnlineStepPositionTrajectoryGeneration * m_HSTEPPOS;
	...
	/*! Using the Herdt's 2010 PG with step position reference. */
