...
ms.load("WalkGenJRL")
walk = ms.create("WalkGenJRL","walk","/home/grxuser/src/OpenHRP/PatternGeneratorJRL/src/PreviewControlParameters.ini /home/grxuser/src/OpenHRP/etc/HRP2JRL/ HRP2JRLmain.wrl")
ms.load("hstabilizer")
...
waitInput("Push [Ok] to go to initial walking position")
#seq.sendMsg(":joint-angles 0 0 -26 50 -24 0 0 0 -26 50 -24 0 0 0 0 0 -30 -30  -10 -50 10 10 10 30 10 0 -30 0 10 10 -10 10 -10 10 -10 -10 10 -10 10 -10 5.0")
#seq.sendMsg(":joint-angles 0 0 -26 50 -24 0 0 0 -26 50 -24 0 0 0 0 0 -30 -30  -10 -50 10 10 10 30 10 0 -30 0 10 10 -10 10 -10 10 -10 -10 10 -10 10 -10 5.0")
seq.sendMsg(":joint-angles 0 0 -26 50 -24 0                                                                          0 0 -26 50 -24 0                                                                          0 0                                                                                       0 0                                                                                       -30 -30 -10 -50 10 10 10                                                                  45 20 0 -10 0 10 10                                                                        -10 10 -10 10 -10 -10 10 -10 10 -10 5.0")
seq.waitInterpolation()

waitInput("Push [Ok] to Start JRL Walking Pattern")
walk.start()
...
walk.sendMsg(":stepseq 0.0 -0.095 0.0 0.2 0.19 0.0 0.2 -0.19 0.0 0.2 0.19 0.0 0.2 -0.19 0.0 0.2 0.19 0.0 0.2 -0.19 0.0 0.2 0.19 0.0 0.2 -0.19 0.0 0.2 0.19 0.0 0.2 -0.19 0.0 0.2 0.19 0.0 0.2 -0.19 0.0 0.0 0.19 0.0")


#normal walking in a circle
#walk.sendMsg(":stepseq 0.0 -0.095 0.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 10.0 0.2 -0.19 10.0 0.2 +0.19 0.0 0.0 -0.19 0.0")	
